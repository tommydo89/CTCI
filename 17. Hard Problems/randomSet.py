...
def randomSet(arr, m):
	...
	# On each iteration, each number has an equal probability of being in the set through either insertion or they were are already in the set and have a low probability of being removed
